...
<div className="bg-neutral-primary-soft max-w-sm p-6 border border-default rounded-base shadow-xs">
    <a href="#">
        <img className="rounded-base" src={props.img} alt="" />
    </a>
    <a href="#">
    ...
    <a href="#" className="inline-flex items-center text-body bg-blue-500 box-border border border-default-medium hover:bg-neutral-tertiary-medium hover:text-heading focus:ring-4 focus:ring-neutral-tertiary shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none">
        Add to Cart
